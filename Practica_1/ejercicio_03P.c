...
Lexico
    ...
    empatados, puntEmp, puntGanados // Intermedio
...
Inicio
    ...
    puntEmp ← empatados * 4
    puntGanados ← ganados * 4
    puntos ← puntGanados + puntEmp + perdidos
...
int jugados, ganados, perdidos, empatados, puntGanados, puntEmp, puntos;
